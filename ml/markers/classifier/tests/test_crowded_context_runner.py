...
from ml.markers.classifier.crowded_context_v8 import runner
...
def test_source_binding_includes_generator_preprocessing_loss_and_policy():
    ...
    assert {"ml/markers/classifier/crowded_context_cache.py",
            "ml/markers/classifier/crowded_context_data.py",
            "ml/markers/classifier/structural_context_cache.py",
