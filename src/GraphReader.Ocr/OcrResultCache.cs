...
public static class OcrCacheKeyDeriver
{
        ...
        string detectorConfigurationFingerprint)
    {
        ...
        {
            yield return FramedLegendRoleResolver.RecoveryCompositionVersion;
        }
        if (options.EnableTickLaneRecovery)
        {
        ...
        if (options.EnableHeaderLayoutRoleResolution)
        {
            yield return HeaderLayoutRoleResolver.CompositionVersion;
        }
        if (options.EnableOriginalPixelBoundsRefinement)
        {
            yield return OriginalPixelTextRegionRefiner.CompositionVersion;
        }
