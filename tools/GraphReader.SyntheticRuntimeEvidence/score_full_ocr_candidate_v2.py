...
OUTPUT_SCHEMA = "graphreader.full-ocr-candidate-score.v2"
...
TRUTH_ROLE_TO_RUNTIME_ROLE = {
    ...
    # The generator derives this header label from its phase code.
    # A condition-bar caption therefore carries phase semantics.
    "condition_label": "phaseheading",
}
RUNTIME_ROLES = frozenset((*TRUTH_ROLE_TO_RUNTIME_ROLE.values(), "other"))
    ...
    *,
    ...
    result = {
        ...
        "role_mapping": {
            ...
            "generator_semantics_source": "ml/synthetic/templates.py",
            "historical_v1_results_remain_unchanged": True,
            "generator_to_serialized_runtime_ocr_role": TRUTH_ROLE_TO_RUNTIME_ROLE,
            "condition_label_rationale": (
                "The generator derives condition_label text from phase.code and places it above that phase. "
                "Its canonical runtime role is PhaseHeading. The absence of a ConditionLabel enum member "
                "does not make the label Other. Unknown roles still fail closed; runtime Other remains valid."
            ),
